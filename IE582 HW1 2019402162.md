...
5.  REFERENCES & CITITIONS  
 ...
 TO ACCESS JUPYTER NOTEBOOK CLICK HERE -> [Fatih Berker Akyıldız's Jupyter Notebook]([https://github.com/BU-IE-582/fall-24-fbaakyildiz/blob/main/hw1jupiter.ipynb](https://github.com/BU-IE-582/fall-24-fbaakyildiz/blob/main/IE582%20HW1%202019402162.ipynb))
 **1**
**Q 3.1** 
```python
import pandas as pd
